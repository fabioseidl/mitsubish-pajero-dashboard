...
lv_obj_t *ui_main = NULL;lv_obj_t *ui_imgbackground = NULL;lv_obj_t *ui_lbspeed = NULL;lv_obj_t *ui_lbrpm = NULL;lv_obj_t *ui_lbfuelrate = NULL;lv_obj_t *ui_lbconsumptionkml = NULL;lv_obj_t *ui_lbavgconsumptionkml = NULL;lv_obj_t *ui_lbdistancekm = NULL;lv_obj_t *ui_lbbarometerpressure = NULL;lv_obj_t *ui_lbambientetemperature = NULL;lv_obj_t *ui_lbatgearposition = NULL;lv_obj_t *ui_lbboostpressure = NULL;
// event funtions
...
ui_imgbackground = lv_image_create(ui_main);
lv_image_set_src(ui_imgbackground, &ui_img_background_png);
lv_obj_set_width( ui_imgbackground, LV_SIZE_CONTENT);  /// 1024
lv_obj_set_height( ui_imgbackground, LV_SIZE_CONTENT);   /// 603
lv_obj_set_align( ui_imgbackground, LV_ALIGN_CENTER );
lv_obj_add_flag( ui_imgbackground, LV_OBJ_FLAG_ADV_HITTEST );   /// Flags
lv_obj_remove_flag( ui_imgbackground, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_set_x( ui_lbspeed, -380 );
lv_obj_set_y( ui_lbspeed, -54 );
lv_obj_set_align( ui_lbspeed, LV_ALIGN_CENTER );
lv_label_set_text(ui_lbspeed,"0");
lv_obj_set_style_text_font(ui_lbspeed, &ui_font_robotobold60, LV_PART_MAIN| LV_STATE_DEFAULT);
